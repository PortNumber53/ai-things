...
def generate_subtitled_video(video, audio, transcript):
    ...
    ffmpeg.concat(video_file.filter("subtitles", transcript), audio_file, v=1, a=1).output("/output/movie/final.mp4").run(quiet=True, overwrite_output=True)
    video_with_subs = open("/output/movie/final.mp4", "rb")
