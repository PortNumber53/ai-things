...
class AiGenerateFunFacts extends Command
{
    ...
    public function handle()
    {
        ...
        $prompt = trim(<<<PROMPT
        give me an unique random fact about a random subject of your choice, make the explanation engaging while keeping it simple
        write about 10 paragraphs, your response must be in JSON format structured like this =>
